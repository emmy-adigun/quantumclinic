				...
				<tbody>
					...
					<a  href="javascript:void(0)" data-id="<?php echo $row['id'] ?>">
						...
						<tr>
							...
							<td><a  href="appointments/comment_index.php?id=<?php echo $row['id'] ?>"><?php echo $row['name'] ?></a></td>
...
<script>
	...
	$(document).ready(function(){
		...
		$('.createcomments').click(function(){
			uni_modal("Comments Details","appointments/comment.php?id="+$(this).attr('data-id'))
		})

		$('.view_comments').click(function(){
			uni_modal("Comments","appointments/view_comment.php?id="+$(this).attr('data-id'))
		})
