...
<div class="card card-outline card-primary">
	<div class="card-header">
		...
		<div class="card-tools">
			<a href="javascript:void(0)" id="create_new" class="btn btn-flat btn-primary"><span class="fas fa-plus"></span>  Create Corporate</a>
		</div>
	</div>
	<div class="card-body">
	<div class="container-fluid">
			...
			<table class="table table-bordered table-stripped" id="indi-list">
				...
				<tbody>
					<?php 
					$i = 1;
						$qry = $conn->query("SELECT id ,name ,address, email, price, code, staff, service FROM `corperate`;");
...
<script>
	...
	$(document).ready(function(){
		$('.view_data').click(function(){
			uni_modal("Corperate","corperate/view_details.php?id="+$(this).attr('data-id'))
		})
		$('#create_new').click(function(){
			uni_modal("Corperate Form","corperate/manage_corperate.php",'mid-large')
		})
		$('.edit_data').click(function(){
			uni_modal("Edit Corperate","corperate/manage_corperate.php?id="+$(this).attr('data-id'),'mid-large')
		})
