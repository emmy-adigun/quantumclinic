              ...
              <div class="os-content" style="padding: 0px 8px; height: 100%; width: 100%;">
                ...
                <nav class="mt-4">
                   <ul class="nav nav-pills nav-sidebar flex-column text-sm nav-compact nav-flat nav-child-indent nav-collapse-hide-child" data-widget="treeview" role="menu" data-accordion="false">
                    ...
                    <li class="nav-item dropdown" >
                      <a href="<?php echo base_url ?>admin/?page=view_schedules" class="nav-link nav-view_schedules">
                         <i class="nav-icon fas fa-calendar-day"></i>
                        <p>
                        Scheduled List
                    ...
                    <li class="nav-item dropdown">
                      <a href="<?php echo base_url ?>admin/?page=corperate" class="nav-link nav-corperate">
                        <i class="nav-icon fas fa-cogs"></i>
                        <p>
                          Corporate
                        </p>
                    ...
                    <li class="nav-item dropdown">
                      <a href="<?php echo base_url ?>admin/?page=random-schedule" class="nav-link nav-corperate">
