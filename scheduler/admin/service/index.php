...
<div class="card card-outline card-primary">
	<div class="card-header">
		...
		<div class="card-tools">
			<a href="javascript:void(0)" id="create_new" class="btn btn-flat btn-primary"><span class="fas fa-plus"></span>  Create Service</a>
		</div>
	</div>
	<div class="card-body">
	<div class="container-fluid">
			...
			<table class="table table-bordered table-stripped" id="indi-list">
				...
				<tbody>
					<?php 
					$i = 1;
						$qry = $conn->query("SELECT id ,type, service_name, service_length, amount FROM `service`;");
							...
							<td align="center">
								 <button type="button" class="btn btn-flat btn-default btn-sm dropdown-toggle dropdown-icon" data-toggle="dropdown">
				                  ...
				                  <div class="dropdown-menu" role="menu">
									...
									<a class="dropdown-item " href="service/delete.php?id=<?php echo $idedit  ?>"> Delete</a>
				                  </div>
							</td>
						</tr>
					<?php endwhile; ?>
...
<script>
	...
	$(document).ready(function(){
		$('.view_data').click(function(){
			uni_modal("Service","service/view_details.php?id="+$(this).attr('data-id'))
		})
		$('#create_new').click(function(){
			uni_modal("Service Form","service/manage_service.php",'mid-large')
		})
		$('.edit_data').click(function(){
			uni_modal("Edit Service","service/manage_service.php?id="+$(this).attr('data-id'),'mid-large')
		})
